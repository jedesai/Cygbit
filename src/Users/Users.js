      ...
      {showSpinner ? (
        ...
        <Table striped bordered hover variant="dark">
          <tbody>
            <tr>
              <td>
                <p className="h5 fw-bold">Id</p>
              </td>
              <td>
                <p className="h5 fw-bold">Avatar</p>
              </td>
              <td>
                <p className="h5 fw-bold">Email</p>
              </td>
              <td>
                <p className="h5 fw-bold">First Name</p>
              </td>
              <td>
                <p className="h5 fw-bold">Last Name</p>
              </td>
            </tr>
            {info.map((user) => (
